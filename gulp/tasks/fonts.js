...
//     return app.gulp.src(`${app.path.src.fonts}`, {allowEmpty: false})
...
export const otfToTtf = () => {
    // console.log(`${app.path.srcFolder}/fonts/*.otf`,{})
    //ищем файлы шрифтов otf
    return app.gulp.src(`${app.path.srcFolder}/fonts/*.otf`, {allowEmpty: false})
        .pipe(app.plugins.plumber(
            app.plugins.notify.onError({
                title: "Fonts",
                message: "Error: <%= error.message %>"
...
export const ttfToWoff = () => {
    //ищем файлы ttf
    return app.gulp.src(`${app.path.srcFolder}/fonts/*.ttf`, {allowEmpty:false})
        .pipe(app.plugins.plumber(
            app.plugins.notify.onError({
                title: "Fonts",
                message: "Error: <%= error.message %>"
...
export const fonstStyle = () => {
    ...
    return app.gulp.src(`${app.path.srcFolder}`,{allowEmpty: false});
    function cb() { }

}
export const fonstStyle2 = () => {
